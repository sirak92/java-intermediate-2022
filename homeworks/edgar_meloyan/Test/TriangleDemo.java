...
class Triangle {
    ...
    double firstLineLength(Point point1, Point point2) {
        return Math.sqrt(Math.pow(point2.x - point1.x, point2.x - point1.x) + Math.pow(point2.y - point1.y, point2.y - point1.y));
    }

    double secondLineLength(Point point3, Point point2) {
        return Math.sqrt(Math.pow(point3.x - point2.x, point3.x - point2.x) + Math.pow(point3.y - point2.y, point3.y - point2.y));
    }

    double thirdLineLength(Point point1, Point point3) {
        return Math.sqrt(Math.pow(point3.x - point1.x, point3.x - point1.x) + Math.pow(point3.y - point1.y, point3.y - point1.y));
    }
